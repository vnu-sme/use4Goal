package org.vnu.sme.goal.istarusebridge.gui;
...
import org.vnu.sme.goal.istarusebridge.IStarUseTraceCompiler.Result;
 ...
 * {@code org.vnu.sme.goal.iscn.gui.IStarScenarioForm} — same role (pick files, run, show a marking report), but
