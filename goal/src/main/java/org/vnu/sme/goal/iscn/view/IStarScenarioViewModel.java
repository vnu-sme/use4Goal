package org.vnu.sme.goal.iscn.view;
...
import org.vnu.sme.goal.iscn.parser.IStarScenarioCompiler.Result;
...
final class IStarScenarioViewModel {
    ...
    static Built build(Result result) {
        GoalModelInstanceEvaluation evaluation = result.evaluation();
        return new Built(evaluation.instanceModel(), badges(evaluation), evaluation.actorLabels(), evaluation.nodeLabels());
    }

    private static Map<String, NodeBadge> badges(GoalModelInstanceEvaluation evaluation) {
