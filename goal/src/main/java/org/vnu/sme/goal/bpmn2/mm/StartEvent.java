...
public final class StartEvent implements Event {
    ...
    public StartEvent(String id, EventTrigger trigger) { this(id, null, trigger, List.of()); }
    public StartEvent(String id, String name, EventTrigger trigger, List<ActivityConstraint> constraints) {
