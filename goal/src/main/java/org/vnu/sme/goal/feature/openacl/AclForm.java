...
public final class AclForm extends JDialog {
    ...
    private final AclOpenService openService;
    ...
    private void open(OpenTarget target) {
        ...
        AclOpenService.Result result = openService.open(source,
                target == OpenTarget.POPUP_WINDOW
                        ? AclOpenService.Target.POPUP_WINDOW : AclOpenService.Target.USE_DESKTOP);
        if (!result.opened()) {
