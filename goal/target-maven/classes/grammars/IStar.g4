...
// Goal contracts are distinct from Task pre/post contracts. Legacy goal
// pre/post/ocl clauses remain accepted through the second alternative.
goalCondition
    : ('trigger' | 'satisfy' | 'while' | 'ensure' | 'release') OCL_BLOCK
    | oclCondition
    ;
