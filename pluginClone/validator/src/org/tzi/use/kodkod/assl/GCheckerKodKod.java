...
public class GCheckerKodKod extends GChecker {
	 ...
	 */
	public GCheckerKodKod(MModel model, boolean check, MainWindow curMainWin, MSystem curSys, HashMap<String, UMLClass> cla, HashMap<String, UMLAssociation> ass, HashMap<String, UMLAssociationClass> assCla, ArrayList<OCLInvar> inv, PrintWriter myLW, AsslTranslation asslTranslation) {
		super(model, new GGeneratorArguments());
