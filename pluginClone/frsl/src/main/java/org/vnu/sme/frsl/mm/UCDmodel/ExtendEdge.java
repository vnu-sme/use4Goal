...
public class ExtendEdge extends EdgeBase{
    
    protected boolean isDashed;

    public ExtendEdge(PlaceableNode source, PlaceableNode target, String name, DiagramView diagram , boolean isDashed) {
    ...
    private void drawEdge( Graphics2D g ) {
        ...
        if ( !fWayPoints.isEmpty() ) {
            ...
            while( it.hasNext() ) {
                ...
                g.drawString("<< include >>", xCenter - width, yCenter - 5);
